...
/* Mengirimkan nol jika List kosong */
	...
	mark = false;	// variabel penanda terbaca MARK
	while(!mark && len <= CAPACITY-1){	// periksa selagi elemen list bukan MARK, periksa dari indeks 0 secara berurut karena elemen rapat kiri
		mark = ELMT(l, len) == MARK;
		
		if(!mark)
			len++;
	}
	// ditemukan MARK atau dicapai indeks terakhir
